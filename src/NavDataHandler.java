...
public class NavDataHandler extends Thread {
    ...
    public NavDataHandler(ARDroneJon drone, InetAddress drone_addr, int data_port, int buffer_size) throws ClosedChannelException, IOException {
        super();
        this.drone = drone;
    ...
    private void connect() throws IOException, ClosedChannelException {
        System.out.println("Connecting nave data server");
        ...
        System.out.println("Nav data server connected");
    }
    ...
    private void disconnect() {
        ...
        System.out.println("Nav data disconnected");
    }
    ...
    public void run()
    {
		...
		void handleReceivedMessageKey(SelectionKey key, ByteBuffer inbuf) throws Exception 
	    {
	        ...
	        } else if(key.isReadable())
	        {
	            ...
	            System.out.println("WE GOT NAV DATA");
